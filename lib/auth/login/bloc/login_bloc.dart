...
import '/core/app_api_exception.dart';

import '/mock/login/mock_login_api.dart';
...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  final MockLoginApi _api = MockLoginApi();
  ...
  FutureOr<void> _onSubmit(
    ...
    try {
      ...
      await AppLocalStorage().save(StorageKeys.roles.name, <String>[
        'ROLE_ADMIN',
      ]);
